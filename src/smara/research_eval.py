...
def score_claims(index:EvidenceIndex,claims:Iterable[ClaimCheck]):
    ...
    for claim in claims:
        ...
        for evidence_id in claim.evidence_ids:
            ...
            supported,reason=index.support(evidence_id,claim.claim,require_fetched=claim.require_fetched);supported_citations+=int(supported);results.append({"evidence_id":evidence_id,"supported":supported,"reason":reason})
