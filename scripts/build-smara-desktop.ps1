...
try {
    ...
    & $python -m PyInstaller --noconfirm --clean --onefile --paths src\smara --hidden-import agent_tools --hidden-import pypdf --hidden-import docx --hidden-import openpyxl --hidden-import pptx --name smara-desktop --distpath build\desktop-executor --workpath build\pyinstaller src\smara\desktop_executor.py
